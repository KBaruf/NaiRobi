    ...
    <Wrapper>
      <div className='section-center'>
        ...
        <div className='content'>
          <p>
            With a little imagination and our expertise, any furniture style is possible. <strong>Join our newsletter</strong> and see the what we've done with just wood, it's unbelievable!{' '}
          </p>
