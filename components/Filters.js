      ...
      <div className='content'>
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className='form-control'>
            ...
            <div>
              {categories.map((cat, index) => {
                return (
                  <button key={index} onClick={updateFilters} name='category' type='button' className={`${category === cat.toLowerCase() ? 'active' : null}`}>
                    {cat}
                  </button>
                );
              })}
          ...
          <div className='form-control shipping'>
            ...
            <input name='shipping' type='checkbox' id='shipping' onClick={updateFilters} checked={shipping} />
          </div>
        </form>
